...
?>
        ...
        <body class="">
            ...
            <div class="container mt-5">
                ...
                <form class="shadow p-3 mt-5 form-w" method="post" action="req/section-edit.php">
                    <h3>Edit Sections</h3>
                    <hr>
                    ...
                    <input type="text" class="form-control" name="section_id" value="<?=$section['section_id']?>" hidden>
