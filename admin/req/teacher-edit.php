    ...
    if (isset($_POST['fname'])    &&
        ...
        isset($_POST['grades'])){
            ...
            if (empty($fname)) {
               ...
               $sql = "UPDATE teachers SET username=?, fname=?, lname=?, subjects= ?, grades=?, address=?, employee_number=?, date_of_birth=?, phone_number=?, qualification=?, gender=?, email_address=?, section=?
                        WHERE teacher_id=?";
               ...
               exit;
                ...
                $em = "An error occured";
                header("Location: ../teacher.php?error=$em&$data"); 
                exit;
            }
        } else {
