        ...
        isset($_POST['date_of_birth'])){
            ...
            if (empty($fname)) {
                ...
                //hashing the password
                  ...
                  $sql = "INSERT INTO registrar_office (username, password, fname, lname, address, employee_number, date_of_birth, phone_number, qualification, gender, email_address) 
                          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                  ...
                  $sm = " New Registrar has registered successfully";
